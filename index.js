...
bot.onText(/\/start/, (msg) => {
    ...
    bot.sendMessage(chatId, `Olá, ${username}! Para começar, digite /iniciar.`);
});
...
bot.onText(/\/iniciar/, (msg) => {
    ...
    sendWithOptions(chatId, `Olá, ${username}! Como posso te ajudar?`, options);
});
